...
Pre-ingested Indian cybercrime taxonomy vectors and RRF (Reciprocal Rank Fusion) hybrid retrieval.
"""
...
SEED_PATTERNS = [
    {
        ...
        "indicators": {"typical_amounts": ["under_100"], "lure_terms": ["electricity", "power", "disconnection", "bill"]},
    ...
    },
    {
        ...
        "indicators": {"lure_terms": ["kyc", "pan card", "blocked", "account suspended", "sbi", "hdfc"]},
    ...
    },
    {
        ...
        "indicators": {"lure_terms": ["customs", "illegal goods", "fedex", "drugs", "mumbai police", "narcotics"]},
    ...
    },
    {
        ...
        "indicators": {"lure_terms": ["scan qr", "receive money", "pin to receive", "refund request"]},
...
class PatternIntelligenceService:
    """Provides semantic pattern matching and tactical precedents."""

    @classmethod
    def match_patterns(cls, narrative: str) -> List[Dict[str, Any]]:
        """Matches narrative against known tactical patterns."""
